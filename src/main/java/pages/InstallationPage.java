...
public class InstallationPage {
    ...
    private final SelenideElement installationDayCFL = $(By.xpath("//span[contains(@class, 'MuiTypography-root') and contains(@class, 'MuiTypography-caption') and text()='08:00-12:00']"));
